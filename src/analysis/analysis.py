...
def draw_bar_chart(file_name: str):
    ...
    one_node_4_core_file_path = DATA_DIR + "n_cores/1node4core-physical" + DATA_FILE_TYPE
    run_time, read_country_code_file_time, process_time, calculate_top_n_time = read_txt(one_node_4_core_file_path)
    x.append("1 node 4 core")
    y.append(run_time)
    ...
    # one_node_24_core_file_path = DATA_DIR + "n_cores/1node24core-physical" + DATA_FILE_TYPE
    # run_time, read_country_code_file_time, process_time, calculate_top_n_time = read_txt(one_node_24_core_file_path)
    # x.append("1 node 24 core")
    # y.append(run_time)
