...
def draw_bar_chart(file_name: str):
    ...
    one_node_16_core_file_path = DATA_DIR + "n_cores/1node16core-physical" + DATA_FILE_TYPE
    run_time, read_country_code_file_time, process_time, calculate_top_n_time = read_txt(one_node_16_core_file_path)
